 ...
 *}
{strip}
{assign var="pageTitle" value="annotations.confirmLemmaDelete"}
...
<form name="submit" action="{if isset($lemmaId)}{url op="deleteLemma" path=$articleId|to_array:$galleyId:$lemmaId:"delete"}{/if}" method="post">
      <p>{translate key="annotations.confirmDeleteLemmaQuestion"}</p>
<table class="data" width="100%">
  <tr valign="top">
	...
	<tr valign="top">
		<td width="20%"></td>
        <td width="80%"><em>{translate key="annotations.warnLemmaDelete"}</em></td>
	</tr>
</table>
